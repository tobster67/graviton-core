...
class MainController
{
    ...
    protected function determineServices(array $optionRoutes)
    {
        $sortArr = array();
        $router = $this->router;
        if( $this->addditionalRoutes && is_array($this->addditionalRoutes) ) {
    ...
    private function registerThirdPartyServices()
    {
        ...
        if( is_array($this->proxySourceConfiguration) && count($this->proxySourceConfiguration) ) {
